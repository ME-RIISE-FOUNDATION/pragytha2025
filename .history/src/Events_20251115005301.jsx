  ...
  const events = [
    {
      ...
      category: "event",
      description:
        "A fusion of creativity and commerce! AdMania challenges participants to craft original ad campaigns and business models for popular brands — blending storytelling, innovation, and strategy. Teams are judged on creativity, impact, and presentation.",
      date: "November 28th",
      ...
      : ""
          ...
          <div className="w-full max-w-lg mx-auto mt-20 mb-24 text-center backdrop-blur-xl bg-white/5 border border-cyan-400/20 rounded-3xl p-8 shadow-lg shadow-cyan-500/10 hover:shadow-cyan-400/30 hover:scale-[1.02] transition-all duration-500 font-mon">
            <h2 className="text-2xl font-semibold text-cyan-300 mb-3 tracking-widest">
              Don’t step onto the battlefield unarmed.
            </h2>
            ...
            <p className="text-gray-300 text-sm mb-6">
              and master the codes of supremacy.
            </p>
