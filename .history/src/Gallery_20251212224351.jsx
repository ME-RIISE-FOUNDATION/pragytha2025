...
const Gallery = () => {
  const events = [
    {
      title: "Inauguration Spark",
      images: [
        "https://placehold.co/1200x600/0f172a/00ffff?text=Inaug+1",
        "https://placehold.co/1200x600/0f172a/00ffff?text=Inaug+2",
        "https://placehold.co/1200x600/0f172a/00ffff?text=Inaug+3",
      ],
    },
    {
      title: "Coding Arena",
